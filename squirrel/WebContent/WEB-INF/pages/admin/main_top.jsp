...
<body>
	...
	<div id="headers" >
	   	...
	   	<div style="float:letf;height:50px;background-color:#232323;">
	   	<div style="float:left;background-color:#00FF7F;height:50px;width:220px;">
	   	<a href="<%=basePath%>admin/indexs">
	   	<p style="font-size:30px;text-align:center;">后台管理</p>
	   	</a>
	   	</div>
	   	<h1 style="text-align:center;margin-top: 10px;margin-bottom: 0px;">C2C二手书共享和交易管理系统</h1>
	   	</div>
