                   ...
                   <div class="changeinfo">
                     ...
                     <div class="changeinfo">
                        ...
                        <select class="in_info" name="catelogId">
                            <option value="1">历史/地理/艺术</option>
                            <option value="2">政治/法律/军事</option>
                            <option value="3">哲学/心理/宗教</option>
                            <option value="4">经济/社科/综合</option>
                            <option value="5">童书/生活/体育</option>
                            <option value="6">工程技术/互联网</option>
                            <option value="7">自然科学/医药卫生</option>
                        </select>
                    </div>
