                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到C2C校园二手市场。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置书籍与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>C2C校园二手市场</p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入C2C校园二手市场，你的大学，应更精彩。</p>
                            </ul>
